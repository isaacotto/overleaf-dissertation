...
% allows for inclusion of pdfs
\usepackage[final]{pdfpages}

% Title formatting
\usepackage{sectsty}
\allsectionsfont{\singlespacing}
\chapterfont{\singlespacing\centering\Large\bfseries\MakeUppercase}
    
% Failed attempts at formatting chapter titles...
%\usepackage{titlesec}
%\titleformat{\chapter}{\normalfont\huge\bfseries\singlespacing}{\thechapter.}{1em}{\huge}
%\usepackage[Lenny]{fncychap}


% needed to make appendices appear correctly in table of contents!
...
% For some reason that I don't bear to consider, only the table of 
% contents NEEDS another \hfill following it, otherwise it slams hard
% to the right. This appears to be a delicate balancing act that works.
\renewcommand{\contentsname}{\hfill \Large TABLE OF CONTENTS \hfill}
\renewcommand{\listfigurename}{\hfill \Large LIST OF FIGURES}
\renewcommand{\listtablename}{\hfill \Large LIST OF TABLES}
