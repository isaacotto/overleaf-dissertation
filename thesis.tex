...
\usepackage{inputenc}
\usepackage[useibid=true]{biblatex-chicago}
...
% Using \include allows you to set \Nincludeonly above.
...
\newpage
\addcontentsline{toc}{chapter}{BIBLIOGRAPHY} % ALLOWS BIBLIOGRAPHY IN TABLE OF CONTENTS -IO
\begingroup
\setstretch{0.8}
%\setlength\bibitemsep{5pt} % default for UCIthesis
\setlength\bibitemsep{6.5pt} % changing this to see if it looks good -IO
